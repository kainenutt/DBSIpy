...
# Convention for diffusivity-like outputs in this codebase: um^2/ms.
_DIFF_UNITS = 'um^2/ms'
...
DTI_MAP_SPECS: Dict[str, MapSpec] = {
    ...
    'dti_axial': MapSpec('DTI axial diffusivity (AD)', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'AD = lambda1.'),
    'dti_radial': MapSpec('DTI radial diffusivity (RD)', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'RD = (lambda2+lambda3)/2.'),
    'dti_adc': MapSpec('DTI mean diffusivity (MD/ADC)', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'MD = (lambda1+lambda2+lambda3)/3.'),
    'dti_lambda_1': MapSpec('DTI eigenvalue lambda1', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'Principal diffusion tensor eigenvalue.'),
    'dti_lambda_2': MapSpec('DTI eigenvalue lambda2', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'Second diffusion tensor eigenvalue.'),
    'dti_lambda_3': MapSpec('DTI eigenvalue lambda3', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'Third diffusion tensor eigenvalue.'),
    'dti_eigenvec_1': MapSpec('DTI principal eigenvector', 'unit vector (x, y, z)', '3-vector', None, 'Unit vector for lambda1 direction.'),
    'dti_eigenvec_2': MapSpec('DTI second eigenvector', 'unit vector (x, y, z)', '3-vector', None, 'Unit vector for lambda2 direction.'),
    'dti_eigenvec_3': MapSpec('DTI third eigenvector', 'unit vector (x, y, z)', '3-vector', None, 'Unit vector for lambda3 direction.'),
...
NODDI_SCALAR_MAP_SPECS: Dict[str, MapSpec] = {
    ...
    'noddi_d_ic': MapSpec('Intra-cellular Diffusivity', _DIFF_UNITS, 'scalar', (0.5, 3.0),
                         'Parallel diffusivity in neurites. Typically fixed at 1.7 um^2/ms.'),
...
_FIBER_SCALAR_METRICS = {
    ...
    'axial': MapSpec('Fiber axial diffusivity (AD)', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'AD = lambda1 from fiber-specific tensor.'),
    'radial': MapSpec('Fiber radial diffusivity (RD)', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'RD = (lambda2+lambda3)/2 from fiber-specific tensor.'),
    'adc': MapSpec('Fiber mean diffusivity (MD/ADC)', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'MD = (lambda1+lambda2+lambda3)/3 from fiber-specific tensor.'),
    'lambda_1': MapSpec('Fiber eigenvalue lambda1', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'Principal eigenvalue of fiber-specific tensor.'),
    'lambda_2': MapSpec('Fiber eigenvalue lambda2', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'Second eigenvalue of fiber-specific tensor.'),
    'lambda_3': MapSpec('Fiber eigenvalue lambda3', _DIFF_UNITS, 'scalar', _DIFF_RANGE, 'Third eigenvalue of fiber-specific tensor.'),
}
