...
Units Convention
~~~~~~~~~~~~~~~~
- **Internal computation**: mm^2/s (SI standard)
- **Output files**: um^2/ms (multiply by 1000)
...
Data Requirements
~~~~~~~~~~~~~~~~~
- **Minimum**: Single-shell high b-value (b>=1000 s/mm^2)
- **Recommended**: Multi-shell (2+ b-values) for better compartment separation
- **Typical**: b=1000 and b=2000 s/mm^2 with 30+ directions each
