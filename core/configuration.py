            ...
            try:
                ...
                if bval_cut < 0 or bval_cut > 20000:
                    raise ConfigurationError(
                        ...
                        f"Should be between 0 and 20000 s/mm².\n"
                ...
                try:
                    ...
                    if d_ic <= 0 or d_ic > 5e-3:
                        raise ConfigurationError(
                            ...
                            f"Intra-cellular diffusivity (mm²/s) should be in range (0, 5e-3].\n"
                            f"Typical value: 1.7e-3 mm²/s"
                        )
                except ValueError:
                    raise ConfigurationError(
                ...
                try:
                    ...
                    if d_iso <= 0 or d_iso > 5e-3:
                        raise ConfigurationError(
                            ...
                            f"Isotropic diffusivity (mm²/s) should be in range (0, 5e-3].\n"
                            f"Typical value: 3.0e-3 mm²/s (free water)"
                        )
                except ValueError:
                    raise ConfigurationError(
